...
@section('content')
<h1 class="text-2xl font-bold text-gray-700 mb-6">Edit Role: {{ $role->cName }}</h1>
...
<div class="bg-white shadow-md rounded-lg p-6">
    <form action="{{ route('roles.update', $role->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="cKode" id="cKode" value="{{ old('cKode', $role->cKode) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('cKode') border-red-500 @enderror" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="cName" id="cName" value="{{ old('cName', $role->cName) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('cName') border-red-500 @enderror" required>
